	...
	module.exports = function( classDefinition ){
		...
		var ClassConstructor = function( options ){
			...
			var binder = function( proto ){
				if( proto.__proto__ ) {
					bindFunctions( instance, proto.__proto__ );
					binder( proto.__proto__ );
				}
			}
			binder( instance );
